...
<div class="col-md-8 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Edit Peminjaman Inventaris</h4>
    <form class="forms-sample" method="POST" action="{{route('peminjaman.update', $peminjaman->id)}}">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" name="nama_peminjam" class="form-control" id="nama_peminjam" value="{{$peminjaman->nama_peminjam}}" placeholder="nama jenis">
              @error('nama_peminjam')
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="date" name="tgl_pinjam" class="form-control" id="tgl_pinjam" value="{{$peminjaman->tgl_pinjam}}" placeholder="tgl_pinjam">
              @error('tgl_pinjam')
                <p class="text-danger text-xs mt-2">{{ $message }}</p>
              @enderror
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="number" name="jum_pinjam" class="form-control" id="jum_pinjam" value="{{$peminjaman->jum_pinjam}}" placeholder="jum_pinjam">
              @error('jum_pinjam')
                <p class="text-danger text-xs mt-2">{{ $message }}</p>
              @enderror
            </div>
