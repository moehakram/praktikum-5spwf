...
<div class="col-md-8 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Edit Pengembalian Inventaris</h4>
    <form class="forms-sample" method="POST" action="{{route('pengembalian.update', $pengembalian->id)}}">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" name="peminjam_id" class="form-control" id="nama_peminjam" value="{{$pengembalian->peminjaman->nama_peminjam}}" placeholder="nama barang" readonly>
              @error('nama_peminjam')
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="date" name="tgl_kembali" class="form-control" id="tgl_kembali" value="{{$pengembalian->tgl_kembali}}" placeholder="tanggal kembali">
              @error('tgl_kembali')
                <p class="text-danger text-xs mt-2">{{ $message }}</p>
              @enderror
            </div>
